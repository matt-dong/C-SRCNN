...
flags.DEFINE_integer("patience", 15, "The steps for early stop [15]")
flags.DEFINE_float("learning_rate", 3e-4, "The learning rate of gradient descent algorithm [3e-4]")
...
flags.DEFINE_integer("stride", 33, "The size of stride to apply input image [33]")
flags.DEFINE_string("checkpoint_dir", "checkpoint/General", "Name of checkpoint directory [checkpoint]")
flags.DEFINE_string("summary_dir", "saved_model", "Name of tensorboard directory [checkpoint]")
...
flags.DEFINE_string("new_image_path","Test/Set5","Path of your image to test")
flags.DEFINE_boolean("make_patch",False,"generate patches even if h5 already exists [False]")
